...
def createScene(rootNode):
                ...
                #model.createObject('BoxROI', name='boxROI', box='15 -15 -10 3 -60 60', drawBoxes= '1')
                #model.createObject('RestShapeSpringsForceField', name = 'fixedForceField', points='@boxROI.indices', stiffness='1e8')
		##########################################
                # Constraint                             
