...
def Reduced_test(
    ...
    pneu.createObject('MeshVTKLoader' , scale3d = multiply(scale,[1.0, 1.0, 1.0]), translation = add(translation,[0.0, 0.0, 0.0]), rotation = add(rotation,[0.0, 0.0, 0.0]), name = 'loader', filename = path + r'/mesh/pneunetCut.vtk')
    ...
    pneu.createObject('BoxROI' , name= 'boxROI' , orientedBox= newBox([[-10.0, 30.0, -20.0], [-10.0, 0.0, -20.0], [0.0, 0.0, -20.0]] , [0.0, 0.0, 0.0],translation,rotation,[0, 0, 20.0],scale) + multiply(scale[2],[40.0]).tolist(),drawBoxes=True)
    pneu.createObject('HyperReducedRestShapeSpringsForceField' , RIDPath = path + r'/data/reducedFF_pneu_1_RID.txt', name = 'reducedFF_pneu_1', weightsPath = path + r'/data/reducedFF_pneu_1_weight.txt', points = '@boxROI.indices', modesPath = path + r'/data/modes.txt', stiffness = '1e12', performECSW = hyperReduction, angularStiffness = '1e12', nbModes = nbrOfModes)
    ...
    cavity.createObject('MeshSTLLoader' , scale3d = multiply(scale,[1.0, 1.0, 1.0]), translation = add(translation,[0.0, 0.0, 0.0]), rotation = add(rotation,[0.0, 0.0, 0.0]), name = 'cavityLoader', filename = path + r'/mesh/pneunetCavityCut.stl')
    ...
    modelCollis.createObject('MeshSTLLoader' , scale3d = multiply(scale,[1.0, 1.0, 1.0]), translation = add(translation,[0.0, 0.0, 0.0]), rotation = add(rotation,[0.0, 0.0, 0.0]), name = 'loader', filename = path + r'/mesh/pneunetCut.stl')
    ...
    visu.createObject('MeshSTLLoader' , scale3d = multiply(scale,[1.0, 1.0, 1.0]), translation = add(translation,[0.0, 0.0, 0.0]), rotation = add(rotation,[0.0, 0.0, 0.0]), name = 'loader', filename = path + r'/mesh/pneunetCut.stl')
