...
def createScene(rootNode):
                ...
                pneu.createObject('MeshVTKLoader', name='loader', filename='/home/owen/Softwares/plugins/ModelOrderReduction/tools/sofa_test_scene/mesh/pneunetCut.vtk')
                ...
                ##########################################
                # Sub topology                           
                #pneu.createObject('BoxROI', name='boxROISubTopo1', box='-100 22.5 -8 -20 30 8', drawBoxes='0')
                ...
                pneu.createObject('BoxROI', name='boxROI', box='-10 0 -20 0 30 20', drawBoxes= '0')
		...
		##########################################
                ...
                cavity.createObject('MeshSTLLoader', name='cavityLoader', filename='/home/owen/Softwares/plugins/ModelOrderReduction/tools/sofa_test_scene/mesh/pneunetCavityCut.stl')
		...
		modelCollis.createObject('MeshSTLLoader', name='loader', filename='/home/owen/Softwares/plugins/ModelOrderReduction/tools/sofa_test_scene/mesh/pneunetCut.stl')
		...
		##########################################
                ...
                modelVisu.createObject(  'MeshSTLLoader', name= 'loader', filename='/home/owen/Softwares/plugins/ModelOrderReduction/tools/sofa_test_scene/mesh/pneunetCut.stl')
