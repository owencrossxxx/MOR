...
def Reduced_test(
    ...
    pneu.createObject('MeshVTKLoader' , scale3d = multiply(scale,[1.0, 1.0, 1.0]), translation = add(translation,[100, 0, 0]), rotation = add(rotation,[0, -90, 0]), name = 'loader', filename = path + r'/mesh/T50.vtu')
    ...
    pneu.createObject('BoxROI' , name= 'membraneROISubTopo' , orientedBox= newBox([[70.0, 70.0, -10.0], [70.0, -5.0, -10.0], [78.0, -5.0, -10.0]] , [100, 0, 0],translation,rotation,[0, 0, 40.0],scale) + multiply(scale[2],[80.0]).tolist(),drawBoxes=True)
    pneu.createObject('BoxROI' , name= 'boxROI' , orientedBox= newBox([[3.0, 70.0, -10.0], [3.0, -5.0, -10.0], [8.0, -5.0, -10.0]] , [100, 0, 0],translation,rotation,[0, 0, 40.0],scale) + multiply(scale[2],[80.0]).tolist(),drawBoxes=True)
    pneu.createObject('HyperReducedRestShapeSpringsForceField' , RIDPath = path + r'/data/reducedFF_pneu_2_RID.txt', name = 'reducedFF_pneu_2', weightsPath = path + r'/data/reducedFF_pneu_2_weight.txt', points = '@boxROI.indices', modesPath = path + r'/data/modes.txt', stiffness = '1e12', performECSW = hyperReduction, angularStiffness = '1e12', nbModes = nbrOfModes)
    ...
    cavity.createObject('MeshSTLLoader' , scale3d = multiply(scale,[1.0, 1.0, 1.0]), translation = add(translation,[100, 1, 1]), rotation = add(rotation,[0, -90, 0]), name = 'cavityLoader', filename = path + r'/mesh/T5Cav.STL')
    cavity.createObject('Mesh' , src = '@cavityLoader', name = 'topo')
    cavity.createObject('MechanicalObject' , name = 'cavity')
    cavity.createObject('SurfacePressureConstraint' , drawScale = '0.0002', name = 'SurfacePressureConstraint', valueType = 'pressure', value = '0', drawPressure = '0', template = 'Vec3d', triangles = '@topo.triangles')
    ...
    modelCollis.createObject('MeshSTLLoader' , scale3d = multiply(scale,[1.0, 1.0, 1.0]), translation = add(translation,[100, 0, 0]), rotation = add(rotation,[0, -90, 0]), name = 'loader', filename = path + r'/mesh/T5.STL')
    ...
    visu.createObject('MeshSTLLoader' , scale3d = multiply(scale,[1.0, 1.0, 1.0]), translation = add(translation,[100, 0, 0]), rotation = add(rotation,[0, -90, 0]), name = 'loader', filename = path + r'/mesh/T5.STL')
