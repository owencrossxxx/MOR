...
def createScene(rootNode):
        ...
        rootNode.createObject('GenericConstraintSolver', tolerance="1e-12", maxIterations="1000000")
        ...
        pneu.createObject('SparseLDLSolver',name='preconditioner')
        ...
        pneu.createObject('MeshVTKLoader', name='loader', filename='/home/owen/Softwares/plugins/ModelOrderReduction/tools/sofa_test_scene/mesh/Ex30.vtu',translation=[0,0,0], rotation = [0,0,0])
        ...
        cavity.createObject('MeshSTLLoader', name='cavityLoader', filename='/home/owen/Softwares/plugins/ModelOrderReduction/tools/sofa_test_scene/mesh/Ex3Cav.STL', translation=[0.5,0.5,2.5], rotation = [0,0,0])
        cavity.createObject('Mesh', src='@cavityLoader', name='cavityMesh')
        cavity.createObject('MechanicalObject', name='cavity')
        cavity.createObject('SurfacePressureConstraint', name="SurfacePressureConstraint", template='Vec3d', value="0", triangles='@cavityMesh.triangles', drawPressure='0',drawScale='0.0002',  valueType="pressure")
        ...
        #collisionpneu1.createObject('MeshSTLLoader', name='loader', filename='/home/owen/Softwares/plugins/ModelOrderReduction/tools/sofa_test_scene/mesh/Ex3_Coarse.STL', translation=[0,0,0], rotation = [0,0,0])
